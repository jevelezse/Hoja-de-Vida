...
\cvachievement{\faFemale}{Ser conferencista en Pycon Colombia}{mostrar a otras personas lo que se puede hacer con Python y R.}
\divider
...
\cvachievement{\faTrophy}{Cabana Travel Fellowships}{Beca para presentar el modelo inicial de mi tesis de maestría en Chile. 2018}
\divider
...
\printbibliography[heading=pubtype,title={\printinfo{\faGroup}{Conferencias y Eventos}},type=inproceedings]
